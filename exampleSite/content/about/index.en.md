...
[![GitHub stars](https://img.shields.io/github/stars/webee/get-started-it?style=social)](https://github.com/webee/get-started-it)
[![GitHub forks](https://img.shields.io/github/forks/webee/get-started-it?style=social)](https://github.com/webee/get-started-it/fork)
{{< /style >}}

> [:(fas fa-running): get-started-it](https://github.com/webee/get-started-it) is a **clean**, **elegant** but **advanced** blog theme for [Hugo](https://gohugo.io/) developed by [webee](https://get-out.me).
>
> It is based on the original [:(far fa-kiss-wink-heart fa-fw): LoveIt](https://github.com/dillonzq/LoveIt), [LeaveIt Theme](https://github.com/liuzc/LeaveIt) and [KeepIt Theme](https://github.com/Fastbyte01/KeepIt).
